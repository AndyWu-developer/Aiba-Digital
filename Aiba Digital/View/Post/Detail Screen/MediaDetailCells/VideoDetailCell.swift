...
class VideoDetailCell: UICollectionViewCell {
    ...
    func configure(with viewModel: VideoViewModel, index : Int){
        ...
        ratioConstraint = videoView.widthAnchor.constraint(equalTo: videoView.heightAnchor, multiplier: CGFloat(viewModel.contentPixelWidth) / CGFloat(viewModel.contentPixelHeight))
